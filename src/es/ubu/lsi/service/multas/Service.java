...
public interface Service {
	...
	/**
	 * Consulta vehiculos. En este caso en particular es importante recuperar toda
	 * la información vinculada a las pistas de sus reservas y jugadores para su
	...
	/**
	 * Inserta un bonus a un conductor.
	 * 
	 * @param nif         NIF del conductor
	 * @param fecha       Fecha en la que se otorga el bonus
	 * @param descripcion Descripción del bonus
	 * @throws PersistenceException si se produce un error
	 */
	public void insertarBonus(String nif, Date fecha, String descripcion) throws PersistenceException;
}
